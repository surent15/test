...
public class BlogResource {
    ...
    public void deleteBlogEntry(String keyword) {
        entryService.deleteBlogEntries(keyword);
    }
    
    @DeleteMapping("/blogs/{id}/clean")
    public void deleteBlogEntryByBlog(Long id, String keyword) {
        entryService.deleteBlogEntriesByBlog(id, keyword);
    }
}
